    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            //级联表 企业
            //级联表
            QiyeEntity qiye = qiyeService.selectById(yonghu.getQiyeId());
            if(qiye != null){
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(false)
            ...
            yonghu.setQiyeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            yonghuEntity.setQiyeId(Integer.valueOf(data.get(0)));   //企业 要改的
