...
*/
@TableName("shangji")
public class ShangjiView extends ShangjiEntity implements Serializable {
	...
	*/
	...
	public ShangjiView(ShangjiEntity shangjiEntity) {
		try {
			BeanUtils.copyProperties(this, shangjiEntity);
	...
	*/
	...
	public String toString() {
		return "ShangjiView{" +
			", shangjiDengjiValue=" + shangjiDengjiValue +
			", shangjiValue=" + shangjiValue +
