...
public class ShangjiZhuanhuaView extends ShangjiZhuanhuaEntity implements Serializable {
	...
	* 商机转化类型的值
	*/
	@ColumnInfo(comment="商机转化类型的字典表值",type="varchar(200)")
	private String shangjiZhuanhuaValue;
	...
	public ShangjiZhuanhuaView() {

	}

	public ShangjiZhuanhuaView(ShangjiZhuanhuaEntity shangjiZhuanhuaEntity) {
		try {
			BeanUtils.copyProperties(this, shangjiZhuanhuaEntity);
	...
	* 获取： 商机转化类型的值
	*/
	public String getShangjiZhuanhuaValue() {
		return shangjiZhuanhuaValue;
	}
	/**
	* 设置： 商机转化类型的值
	*/
	public void setShangjiZhuanhuaValue(String shangjiZhuanhuaValue) {
		this.shangjiZhuanhuaValue = shangjiZhuanhuaValue;
	}
	...
	public String toString() {
		return "ShangjiZhuanhuaView{" +
			", shangjiZhuanhuaValue=" + shangjiZhuanhuaValue +
