...
public class XiansuoZhuanhuaView extends XiansuoZhuanhuaEntity implements Serializable {
	...
	* 线索转化类型的值
	*/
	@ColumnInfo(comment="线索转化类型的字典表值",type="varchar(200)")
	private String xiansuoZhuanhuaValue;
	...
	public XiansuoZhuanhuaView() {

	}

	public XiansuoZhuanhuaView(XiansuoZhuanhuaEntity xiansuoZhuanhuaEntity) {
		try {
			BeanUtils.copyProperties(this, xiansuoZhuanhuaEntity);
	...
	* 获取： 线索转化类型的值
	*/
	public String getXiansuoZhuanhuaValue() {
		return xiansuoZhuanhuaValue;
	}
	/**
	* 设置： 线索转化类型的值
	*/
	public void setXiansuoZhuanhuaValue(String xiansuoZhuanhuaValue) {
		this.xiansuoZhuanhuaValue = xiansuoZhuanhuaValue;
	}
	...
	public String toString() {
		return "XiansuoZhuanhuaView{" +
			", xiansuoZhuanhuaValue=" + xiansuoZhuanhuaValue +
