...
public class LixiangPingshenView extends LixiangPingshenEntity implements Serializable {
	...
	* 项目评审类型的值
	*/
	@ColumnInfo(comment="项目评审类型的字典表值",type="varchar(200)")
	private String lixiangPingshenValue;
	/**
	* 项目评审状态的值
	*/
	@ColumnInfo(comment="项目评审状态的字典表值",type="varchar(200)")
	private String lixiangPingshenYesnoValue;
	...
	public LixiangPingshenView() {

	}

	public LixiangPingshenView(LixiangPingshenEntity lixiangPingshenEntity) {
		try {
			BeanUtils.copyProperties(this, lixiangPingshenEntity);
	...
	* 获取： 项目评审类型的值
	*/
	public String getLixiangPingshenValue() {
		return lixiangPingshenValue;
	}
	/**
	* 设置： 项目评审类型的值
	*/
	public void setLixiangPingshenValue(String lixiangPingshenValue) {
		this.lixiangPingshenValue = lixiangPingshenValue;
	}
	//当前表的
	/**
	* 获取： 项目评审状态的值
	*/
	public String getLixiangPingshenYesnoValue() {
		return lixiangPingshenYesnoValue;
	}
	/**
	* 设置： 项目评审状态的值
	*/
	public void setLixiangPingshenYesnoValue(String lixiangPingshenYesnoValue) {
		this.lixiangPingshenYesnoValue = lixiangPingshenYesnoValue;
	}
	...
	public String toString() {
		return "LixiangPingshenView{" +
			", lixiangPingshenValue=" + lixiangPingshenValue +
			", lixiangPingshenYesnoValue=" + lixiangPingshenYesnoValue +
