...
public class LixiangGenjinView extends LixiangGenjinEntity implements Serializable {
	...
	public LixiangGenjinView() {

	}

	public LixiangGenjinView(LixiangGenjinEntity lixiangGenjinEntity) {
		try {
			BeanUtils.copyProperties(this, lixiangGenjinEntity);
