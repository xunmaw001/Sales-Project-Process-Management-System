...
*/
@TableName("lixiang")
public class LixiangView extends LixiangEntity implements Serializable {
	...
	*/
	...
	public LixiangView(LixiangEntity lixiangEntity) {
		try {
			BeanUtils.copyProperties(this, lixiangEntity);
	...
	*/
	...
	public String toString() {
		return "LixiangView{" +
			", lixiangValue=" + lixiangValue +
			", lixiangYesnoValue=" + lixiangYesnoValue +
