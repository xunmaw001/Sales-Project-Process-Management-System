        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="负责人" prop="qiyeFuzeren">
                       <el-input v-model="ruleForm.qiyeFuzeren"
                                 placeholder="负责人" clearable  :readonly="ro.qiyeFuzeren"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.qiyeContent"  label="企业介绍" prop="qiyeContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qiyeContent" label="企业介绍" prop="qiyeContent">
